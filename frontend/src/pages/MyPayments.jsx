        ...
        <>
                  ...
                  <div key={auction.id} className="bg-white rounded-[2rem] overflow-hidden shadow-lg border-2 border-emerald-200">
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <div className="flex items-center justify-between p-4 bg-neutral-100 rounded-xl">
                        <div>
                          <p className="text-xs font-bold text-green-600 uppercase">Sold Price</p>
                          <p className="text-2xl font-bold text-brand-primary">{formatPrice(auction.current_price)}</p>
                        </div>
                        <div className="text-right">
                          <p className="text-xs font-bold text-green-600 uppercase">Buyer</p>
                ...
                {pendingPayments.map((auction) => (
                  <div key={auction.id} className="bg-white rounded-[2rem] overflow-hidden shadow-lg border-2 border-amber-200">
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <div className="flex items-center justify-between p-4 bg-neutral-100 rounded-xl">
                        <div>
                          <p className="text-xs font-bold text-green-600 uppercase">Winning Bid</p>
                          <p className="text-2xl font-bold text-brand-primary">{formatPrice(auction.current_price)}</p>
                        </div>
                        <div className="text-right">
                          <p className="text-xs font-bold text-green-600 uppercase">Seller</p>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <button
                            ...
                            className="flex flex-col items-center gap-2 p-4 bg-gradient-to-br from-brand-secondary to-brand-primary text-white rounded-xl font-bold hover:from-brand-primary hover:to-brand-secondary/20 transition-all disabled:opacity-50"
                          >
                      ...
                      <div className="p-4 bg-blue-50 rounded-xl">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-green-600">Waiting for admin verification</p>
                          </div>
                        </div>
          ...
          {auctions.length === 0 && soldAuctions.length === 0 && (
            <div className="text-center py-16 bg-white rounded-[2rem] shadow-sm">
              <MaterialSymbol icon="shopping_bag" size={64} className="mx-auto text-neutral-400 mb-4" />
          ...
          <div className="bg-white w-full max-w-md rounded-3xl shadow-xl overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              <div className="p-4 bg-neutral-100 rounded-xl">
                <p className="text-xs font-bold text-green-600 uppercase">Amount to Pay</p>
                <p className="text-3xl font-bold text-brand-primary">{formatPrice(selectedAuction.current_price)}</p>
                <p className="text-sm text-green-600 mt-1">{selectedAuction.title}</p>
              </div>

              <div className="space-y-3">
                <label className="block text-xs font-bold text-neutral-600 uppercase tracking-widest">
                  Card Details
                </label>
                <div ref={cardContainerRef} id="card-element" className="p-4 bg-white border-2 border-neutral-300 rounded-xl focus-within:border-brand-accent transition-colors">
                </div>
                {cardError && (
