  ...
  if (!auction) {
    return (
      <div className="text-center py-16">
        ...
        <p className="text-neutral-600 text-lg">Auction not found</p>
      </div>
    );
  }
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-600 mt-1">Update auction details and settings</p>
        </div>
        <button
          onClick={() => navigate(`/auctions/${id}`)}
          className="px-4 py-2 border border-neutral-400 rounded-xl text-neutral-600 font-semibold hover:bg-neutral-300 transition-colors flex items-center gap-2"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-neutral-700 font-semibold"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="4"
              className="w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-neutral-700 font-semibold resize-none"
            />
          </div>
          ...
          <div className="flex justify-end gap-4 pt-4">
            <button
              type="button"
              onClick={() => navigate(`/auctions/${id}`)}
              className="px-6 py-3 border border-neutral-400 rounded-xl text-neutral-600 font-bold hover:bg-neutral-300 transition-colors"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={submitting}
              className="px-6 py-3 bg-brand-primary text-white rounded-xl font-bold hover:bg-brand-secondary transition-colors disabled:opacity-50 flex items-center gap-2"
            >
