    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-600 mt-1">Manage auction winner payments</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl p-12 text-center">
          ...
          <p className="text-neutral-600 text-lg">No {filter} payments</p>
        </div>
      ) : (
          ...
          {auctions.map((auction) => (
            <div key={auction.id} className="bg-white rounded-xl p-6 shadow-sm">
              <div className="flex items-start justify-between">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-500">Auction #{auction.id}</p>
              ...
              <div className="mt-4 pt-4 border-t grid grid-cols-2 md:grid-cols-4 gap-4">
                <div>
                  <p className="text-xs text-neutral-500 uppercase">Winner</p>
                  <p className="font-medium text-brand-primary">{auction.winner?.name || 'Unknown'}</p>
                </div>
                <div>
                  <p className="text-xs text-neutral-500 uppercase">Owner</p>
                  <p className="font-medium text-brand-primary">{auction.owner?.name || 'Unknown'}</p>
                </div>
                <div>
                  <p className="text-xs text-neutral-500 uppercase">Payment Deadline</p>
                ...
                <div>
                  <p className="text-xs text-neutral-500 uppercase">Bids</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-2xl">
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-4">
              <p className="text-sm text-neutral-500">Auction</p>
            ...
            <div className="mb-4">
              <label className="block text-sm font-medium text-neutral-600 mb-2">Notes (optional)</label>
              <textarea
                value={notes}
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3 bg-gray-100 text-neutral-600 rounded-lg font-medium hover:bg-gray-200"
              >
                Cancel
              </button>
              <button
