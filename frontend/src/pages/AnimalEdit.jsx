    ...
    <form onSubmit={handleSubmit} className="min-h-screen pb-24">
      ...
      <header className="w-full sticky top-0 z-40 bg-stone-50/80 backdrop-blur-xl flex justify-between items-center px-8 py-4 shadow-[0px_12px_32px_rgba(6,64,43,0.06)]">
        ...
        <div className="flex gap-3">
          ...
          <button type="submit" disabled={isSubmitting} className="px-8 py-2.5 rounded-xl bg-brand-primary text-white font-bold hover:bg-brand-secondary shadow-lg shadow-brand-primary/20 transition-all text-sm flex items-center gap-2 disabled:opacity-50">
      ...
      <div className="p-8">
        {message && (
          <div className={`mb-6 p-4 rounded-xl ${message.type === 'success' ? 'bg-green-100 text-brand-primary' : 'bg-red-50 text-red-800'}`}>
            {message.text}
          </div>
        )}
          ...
          <div className="col-span-12 lg:col-span-8 space-y-8">
            ...
            <section className="bg-white p-8 rounded-xl shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                <MaterialSymbol icon="info" className="text-yellow-800" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-1.5">
                  ...
                  <input 
                    ...
                    className="w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-emerald-900 font-semibold focus:ring-2 focus:ring-brand-secondary/10" 
                  />
                </div>
<div className="space-y-1.5">
                  <label className="text-[11px] font-bold text-stone-500 uppercase tracking-widest px-1">Species</label>
                  <select name="species" value={formData.species} onChange={handleChange} disabled={isShepherd} className={`w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-emerald-900 font-semibold focus:ring-2 focus:ring-brand-secondary/10 ${isShepherd ? 'opacity-50 cursor-not-allowed' : ''}`}>
                  ...
                  {formData.species === 'Other' && !isShepherd && (
                    <input 
                      ...
                      className="w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-emerald-900 font-semibold focus:ring-2 focus:ring-brand-secondary/10 mt-2" 
                    />
                  )}
                </div>
                <div className="space-y-1.5">
                  ...
                  <select 
                    ...
                    onChange={handleChange} 
                    disabled={isShepherd}
                    className={`w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-emerald-900 font-semibold focus:ring-2 focus:ring-brand-secondary/10 ${isShepherd ? 'opacity-50 cursor-not-allowed' : ''}`}
                  >
                ...
                <div className="space-y-1.5">
                  ...
                  <input name="date_of_birth" value={formData.date_of_birth} onChange={handleChange} type="date" className="w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-emerald-900 font-semibold focus:ring-2 focus:ring-brand-secondary/10" />
                </div>
                <div className="space-y-1.5">
                  <label className="text-[11px] font-bold text-stone-500 uppercase tracking-widest px-1">{t('animals.gender')}</label>
                  <select name="gender" value={formData.gender} onChange={handleChange} className="w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-emerald-900 font-semibold focus:ring-2 focus:ring-brand-secondary/10">
                ...
                <div className="space-y-1.5">
                  ...
                  <input name="current_weight" value={formData.current_weight} onChange={handleChange} type="number" step="0.01" placeholder="0.00" className="w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-emerald-900 font-semibold focus:ring-2 focus:ring-brand-secondary/10" />
                </div>
              </div>
            </section>
            ...
            <section className="bg-white p-8 rounded-xl shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                <MaterialSymbol icon="photo_camera" className="text-yellow-800" />
              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="w-full md:w-64">
                  <div className="relative group aspect-square rounded-xl overflow-hidden shadow-inner bg-stone-100 cursor-pointer" onClick={() => fileInputRef.current?.click()}>
                    {imagePreview ? (
                      ...
                      <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-neutral-200 to-green-100">
                ...
                <div className="flex-1 space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <textarea name="color_markings" value={formData.color_markings} onChange={handleChange} rows="6" placeholder={t('animals.colorMarkingsPlaceholder')} className="w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-emerald-900 font-medium focus:ring-2 focus:ring-brand-secondary/10 resize-none" />
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="bg-white p-8 rounded-xl shadow-sm">
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                  <MaterialSymbol icon="monitor_heart" className="text-yellow-800" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <input name="baseline_temperature" value={formData.baseline_temperature} onChange={handleChange} type="number" step="0.1" placeholder="38.5" className="w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-emerald-900 font-semibold focus:ring-2 focus:ring-brand-secondary/10" />
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <input name="normal_heart_rate" value={formData.normal_heart_rate} onChange={handleChange} type="number" placeholder="45" className="w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-emerald-900 font-semibold focus:ring-2 focus:ring-brand-secondary/10" />
                  </div>
                </div>
          ...
          <div className="col-span-12 lg:col-span-4 space-y-8">
            ...
            {!isNewAnimal && (
              <section className="bg-neutral-300 rounded-[1.5rem] p-6 transition-all hover:shadow-md">
                <div className="flex items-center gap-3 mb-6">
                ...
                <div className="flex flex-col items-center gap-4 p-5 bg-white rounded-2xl shadow-sm border border-green-100/30">
                  {currentDevice ? (
                    <>
                      <div className="w-20 h-20 rounded-2xl overflow-hidden shadow-lg border-2 border-white flex-shrink-0">
                        {existingImage || imagePreview ? (
                          ...
                          <div className="w-full h-full bg-gradient-to-br from-neutral-200 to-green-100 flex items-center justify-center">
                      ...
                      <div className="flex-grow text-center">
                        ...
                        <p className="text-xs text-neutral-600 mb-1">{formData.species} {formData.breed && `• ${formData.breed}`} {formData.gender && `• ${formData.gender}`}</p>
                      ...
                      <div className="flex gap-2 w-full">
                        <button 
                          ...
                          className="flex-1 px-4 py-2.5 rounded-xl border border-neutral-400 text-xs font-semibold text-neutral-600 hover:bg-neutral-300 transition-colors"
                        >
                    ...
                    <>
                      <div className="w-20 h-20 rounded-2xl bg-neutral-300 flex items-center justify-center shadow-inner">
                        <MaterialSymbol icon="link_off" size={40} className="text-brand-primary/30" />
                      </div>
                      <div className="flex-grow text-center">
                        <h5 className="text-base font-bold text-neutral-600">{t('animals.noDeviceAssignedAlt')}</h5>
                        <p className="text-xs text-neutral-500 mb-1">{t('animals.linkDevice')}</p>
                        <div className="flex items-center justify-center gap-2">
                          <span className="w-2 h-2 rounded-full bg-neutral-400"></span>
                          <span className="text-[10px] font-bold uppercase text-neutral-500 tracking-wider">{t('animals.notLinked')}</span>
                        </div>
                      </div>
                      <button 
                        type="button"
            ...
            <section className="bg-white p-6 rounded-xl shadow-sm">
              ...
              {devicesLoading ? (
                ...
                <>
                  <select name="device_id" value={formData.device_id} onChange={handleDeviceChange} className="w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-emerald-900 font-semibold mb-4">
            ...
            <section className="bg-white p-6 rounded-xl shadow-sm">
              ...
              {devicesLoading ? (
                ...
                <>
                  <select name="owner_id" value={formData.owner_id} onChange={handleOwnerChange} className="w-full bg-neutral-100 border-none rounded-xl px-4 py-3 text-emerald-900 font-semibold mb-4">
