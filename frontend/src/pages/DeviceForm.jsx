    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-neutral-300 rounded-3xl p-8 transition-all hover:shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3 py-3">
                  ...
                  <span className="text-sm text-neutral-600">Enable high-frequency GPS polling</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-neutral-300 rounded-3xl p-8 transition-all hover:shadow-md">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-bold font-['Manrope'] text-brand-primary">Ownership</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-neutral-600/70 px-1">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3 bg-brand-primary text-white rounded-xl font-bold text-sm hover:bg-brand-secondary transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
              >
              ...
              <button
                type="button"
                onClick={handleCancel}
                className="w-full py-3 bg-neutral-300 text-brand-primary rounded-xl font-bold text-sm hover:bg-neutral-100 transition-colors"
              >
                Cancel
              </button>
            </div>
